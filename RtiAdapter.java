...
public class RtiAdapter extends NullFederateAmbassador {
   ...
   /**
    * Resolve a (possibly short) object class name to the RTI's canonical,
    * fully-qualified name (e.g. {@code Vehicle} -> {@code HLAobjectRoot.Vehicle}).
    *
    * <p>Subscriptions are keyed on this canonical name so they match the names
    * the {@link FederateAmbassador} callbacks resolve via {@code getObjectClassName},
    * regardless of which spelling the Sub-App used to subscribe.
    */
   public String canonicalObjectClassName(String objectClassName)
         throws RTIexception
   {
      return _rtiAmbassador.getObjectClassName(_rtiAmbassador.getObjectClassHandle(objectClassName));
   }

   /** Canonical, fully-qualified interaction class name; see {@link #canonicalObjectClassName}. */
   public String canonicalInteractionClassName(String interactionName)
         throws RTIexception
   {
      return _rtiAmbassador.getInteractionClassName(_rtiAmbassador.getInteractionClassHandle(interactionName));
   }
